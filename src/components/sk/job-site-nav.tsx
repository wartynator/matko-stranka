  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-[#07101f]/95 backdrop-blur-md">
      <div className="mx-auto flex h-20 w-full max-w-[1440px] items-center justify-between gap-5 px-5 sm:px-8 lg:px-12">
        <Link href="/" aria-label="M&J Elektro - pracovná ponuka" className="relative size-14 shrink-0 overflow-hidden bg-[#07101f]">
          <Image
            src="/mj-elektro-logo-square.jpg"
            alt="M&J Elektro"
            fill
            priority
            sizes="56px"
            className="object-contain [filter:invert(1)_hue-rotate(180deg)_brightness(1.18)_contrast(1.08)]"
          />
        </Link>
